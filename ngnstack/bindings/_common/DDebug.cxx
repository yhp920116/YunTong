...
static int debug_xxx_cb(const void* arg, const char* fmt, enum cb_type type, va_list *app)
{
	int ret = -1;
	if(!arg){
		return -1;
	...
	const DDebugCallback* dbgcb = dyn_cast<const DDebugCallback*>((const DDebugCallback*)arg);
