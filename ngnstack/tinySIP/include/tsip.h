...
* @code
* int ret = tsip_stack_set(stack, 
*              TSIP_STACK_SET_PROXY_CSCF("pcscf-weicall.net", 4060, "tcp", "ipv6"),
*              TSIP_STACK_SET_NULL());
* @endcode
*
...
#define TSIP_STACK_SET_SECAGREE_ENCRYPT(ENABLED_BOOL)		tsip_pname_secagree_encrypt, (tsk_bool_t)ENABLED_BOOL
...
* @code
* int ret = tsip_stack_set(stack, 
*              TSIP_STACK_SET_HEADER("User-Agent", "IM-client/OMA1.0 weicall/v1.0.0"),
