		...
		if(layer){
			...
			*/
			if(transac){
                ...
                case tsip_ist: /**< Invite Server Transaction. */
                case tsip_nist: /**< Non-Invite Server Transaction. */
                    break;
				}
...
int tsip_dialog_update_2(tsip_dialog_t *self, const tsip_request_t* invite)
{
	...
	tsk_strupdate(&self->tag_remote, invite->From?invite->From->tag:"cc");
