...
{
	tsk_size_t i;
    TSK_DEBUG_INFO("tmedia_codec_plugin_register: %s", plugin->name);
...
int tmedia_codec_plugin_register_2(const tmedia_codec_plugin_def_t* plugin, int prio)
{
    ...
    TSK_DEBUG_INFO("tmedia_codec_plugin_register_2: %s", plugin->name);
...
int tmedia_codec_plugin_unregister(const tmedia_codec_plugin_def_t* plugin)
{
    ...
    TSK_DEBUG_INFO("tmedia_codec_plugin_unregister: %s", plugin->name);
