...
#	define JB_HISTORY_SIZE 50  //GARY TEST ORIGINAL 500
#endif
...
//GARY TEST ORIGINAL 6000
#define JB_MAX_DIFF 1000 //in a RTP stream the max_diff may be 3000 packets (most packets are 20ms)
