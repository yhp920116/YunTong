...
+ (XMPPJID *)jidWithUser:(NSString *)user deviceToken:(NSString *)_deviceToken domain:(NSString *)domain resource:(NSString *)resource;

@property (strong, readonly) NSString *user;
@property (strong, readonly) NSString *deviceToken;
