...
//	[self setClipsToBounds:YES];
	...
	// Set the font
	tickerFont = [UIFont fontWithName:@"Helvetica" size:15.0];
...
-(void)animateCurrentTickerString
{
    ...
    CGFloat w = [currentString sizeWithFont:[UIFont fontWithName:@"Marker Felt" size:17.0]].width;
    
	// Calculate the size of the text and update the frame size of the ticker label
	CGSize textSize = [currentString sizeWithFont:tickerFont constrainedToSize:CGSizeMake(w, self.frame.size.height) lineBreakMode:UILineBreakModeWordWrap];
	...
	[UIView beginAnimations:@"subtitleAnimation" context:nil];
